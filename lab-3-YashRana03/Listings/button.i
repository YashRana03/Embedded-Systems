...
# 111 "C:/Users/Kumar/AppData/Local/Arm/Packs/Keil/Kinetis_KLxx_DFP/1.15.1/Device/Include\\MKL25Z4.h"
...
# 112 "C:/Users/Kumar/AppData/Local/Arm/Packs/Keil/Kinetis_KLxx_DFP/1.15.1/Device/Include\\MKL25Z4.h" 2
...
# 1 "src/..\\inc\\button.h" 1
# 14 "src/..\\inc\\button.h"
# 1 "src/..\\inc/mask.h" 1
# 15 "src/..\\inc\\button.h" 2
# 43 "src/..\\inc\\button.h"
_Bool isPressed(uint32_t bmask) ;

void configureButtons(uint32_t bmask, _Bool interrupt) ;
# 14 "src/button.c" 2
# 26 "src/button.c"
void configureButtons(uint32_t mask, _Bool interrupt) {


    if (mask & ((1UL << ((4))) | (1UL << ((5))) | (1UL << ((16))))) {
        ((SIM_Type *)(0x40047000u))->SCGC5 |= 0x200u ;
    }
    if (mask & ((1UL << ((0))) | (1UL << ((1))))) {
        ((SIM_Type *)(0x40047000u))->SCGC5 |= 0x400u ;
    }


    const uint32_t gpioPullUp = (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | 0x1u | 0x2u ;
    const uint32_t clearMUX_IRQ = ~(0x700u | 0xF0000u) ;


    if (mask & (1UL << ((4)))) {

        ((PORT_Type *)(0x40049000u))->PCR[(4)] &= clearMUX_IRQ ;
        ((PORT_Type *)(0x40049000u))->PCR[(4)] |= gpioPullUp ;

        ((GPIO_Type *)(0x400FF000u))->PDDR &= ~(1UL << ((4))) ;
    }
    if (mask & (1UL << ((5)))) {

        ((PORT_Type *)(0x40049000u))->PCR[(5)] &= clearMUX_IRQ ;
        ((PORT_Type *)(0x40049000u))->PCR[(5)] |= gpioPullUp ;

        ((GPIO_Type *)(0x400FF000u))->PDDR &= ~(1UL << ((5))) ;
    }
    if (mask & (1UL << ((0)))) {

        ((PORT_Type *)(0x4004A000u))->PCR[(0)] &= clearMUX_IRQ ;
        ((PORT_Type *)(0x4004A000u))->PCR[(0)] |= gpioPullUp ;

        ((GPIO_Type *)(0x400FF040u))->PDDR &= ~(1UL << ((0))) ;
    }
    if (mask & (1UL << ((1)))) {

        ((PORT_Type *)(0x4004A000u))->PCR[(1)] &= clearMUX_IRQ ;
        ((PORT_Type *)(0x4004A000u))->PCR[(1)] |= gpioPullUp ;

        ((GPIO_Type *)(0x400FF040u))->PDDR &= ~(1UL << ((1))) ;
    }


    if (mask & (1UL << ((16)))) {

        ((PORT_Type *)(0x40049000u))->PCR[(16)] &= clearMUX_IRQ ;
        ((PORT_Type *)(0x40049000u))->PCR[(16)] |= gpioPullUp ;

        ((GPIO_Type *)(0x400FF000u))->PDDR &= ~(1UL << ((16))) ;

        if (interrupt) {
            ((PORT_Type *)(0x40049000u))->PCR[(16)] |= (((uint32_t)(((uint32_t)(0x0A))<<16))&0xF0000u) ;


            __NVIC_SetPriority(PORTA_IRQn, 128);
            __NVIC_ClearPendingIRQ(PORTA_IRQn);
...
_Bool isPressed(uint32_t bmask) {
    ...
    if (bmask & ((1UL << ((4))) | (1UL << ((5))) | (1UL << ((16))))) {
        if (((GPIO_Type *)(0x400FF000u))->PDIR & bmask) {
            return 0 ;
        }
        return 1 ;
    } else {
        if (((GPIO_Type *)(0x400FF040u))->PDIR & bmask) {
            return 0 ;
        }
        return 1;
    }
