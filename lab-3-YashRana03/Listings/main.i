...
# 1 "src/..\\inc\\SysTick.h" 1
# 16 "src/..\\inc\\SysTick.h"
...
volatile uint32_t pressedB5_ev;
# 60 "src/main.c"
int state3Leds = (4);
...
void PORTA_IRQHandler(void) {
    ...
    if ((((PORT_Type *)(0x40049000u))->ISFR & (1UL << ((16))))) {
    ...
    ((PORT_Type *)(0x40049000u))->ISFR = (1UL << ((16)));
}
