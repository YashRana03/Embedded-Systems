...
void configureRGB(void) ;
void setRGB (RGB_t l, int onOff) ;
# 8 "src/rgb.c" 2
...
void configureRGB() {
  ...
  ((SIM_Type *)(0x40047000u))->SCGC5 |= 0x400u | 0x1000u;


  ((PORT_Type *)(0x4004A000u))->PCR[(18)] &= ~0x700u;
  ((PORT_Type *)(0x4004A000u))->PCR[(18)] |= (((uint32_t)(((uint32_t)(1))<<8))&0x700u);
  ((PORT_Type *)(0x4004A000u))->PCR[(19)] &= ~0x700u;
  ((PORT_Type *)(0x4004A000u))->PCR[(19)] |= (((uint32_t)(((uint32_t)(1))<<8))&0x700u);
  ((PORT_Type *)(0x4004C000u))->PCR[(1)] &= ~0x700u;
  ((PORT_Type *)(0x4004C000u))->PCR[(1)] |= (((uint32_t)(((uint32_t)(1))<<8))&0x700u);


  ((GPIO_Type *)(0x400FF040u))->PDDR |= (1UL << ((18))) | (1UL << ((19)));
  ((GPIO_Type *)(0x400FF0C0u))->PDDR |= (1UL << ((1)));


  ((GPIO_Type *)(0x400FF040u))->PSOR = (1UL << ((18))) | (1UL << ((19)));
  ((GPIO_Type *)(0x400FF0C0u))->PSOR = (1UL << ((1)));
...
void setRGB(RGB_t rgb, int onOff) {
    switch (rgb) {
        case RED:
            if (onOff == 1) {
                ((GPIO_Type *)(0x400FF040u))->PCOR = (1UL << ((18))) ;
            } else {
                ((GPIO_Type *)(0x400FF040u))->PSOR = (1UL << ((18))) ;
            }
            break ;
        case GREEN:
            if (onOff == 1) {
                ((GPIO_Type *)(0x400FF040u))->PCOR = (1UL << ((19))) ;
            } else {
                ((GPIO_Type *)(0x400FF040u))->PSOR = (1UL << ((19))) ;
            }
            break ;
        case BLUE:
            if (onOff == 1) {
                ((GPIO_Type *)(0x400FF0C0u))->PCOR = (1UL << ((1))) ;
            } else {
                ((GPIO_Type *)(0x400FF0C0u))->PSOR = (1UL << ((1))) ;
            }
            break ;
